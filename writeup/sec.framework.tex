...
Damit Bienen die Blumen in ihrer Umwelt sehen können sind alle aktiven Entitäten der Simulation in einer Klasse \code{Environment} registriert. Die \code{Environment} zeigt den Bienen verfügbare Blumen und kümmert sich um das Erneuern des Nektars aller Blüten.

...
Für diese Simulation werden drei konkrete \code{PositionedEntity} Klassen benötigt: Bienenstöcke, Bienen und Blumen. Abbildung~\ref{img:entities} zeigt die entsprechenden Klassen.
